...
Blank_img = PhotoImage(file="Assests/blank.png")
Player_Rock = PhotoImage(file="Assests/rock_player.png")
Player_Rock_ado = Player_Rock.subsample(3, 3)
Player_Paper = PhotoImage(file="Assests/paper_player.png")
Player_Paper_ado = Player_Paper.subsample(3, 3)
Player_Scissor = PhotoImage(file="Assests/scissor_player.png")
Player_Scissor_ado = Player_Scissor.subsample(3, 3)
Computer_Rock = PhotoImage(file="Assests/rock_computer.png")
Computer_Paper = PhotoImage(file="Assests/paper_computer.png")
Computer_Scissor = PhotoImage(file="Assests/scissor_computer.png")
